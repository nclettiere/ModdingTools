...
int main(int argc, char *argv[])
{
	...
	if (argc != 3)
	{
...
#ifdef _WIN32
		std::string def_srcFolder = "C:\\Program Files (x86)\\Steam\\steamapps\\workshop\\content\\108600";
#else
		std::string def_srcFolder = "/opt/steam/workshop/content/108600";
#endif
		...
		printf("Carpeta de Steam Workshop PZ (%s) \n[ENTER] ", def_srcFolder.c_str());
		std::getline(std::cin, srcFolder);

		if (srcFolder.empty())
		{
			srcFolder = def_srcFolder;
		}
